...
class MonsterFour(Monster): 
    ...
    def _draw_basic_monster(self):
        ...
        pygame.draw.rect(self.surface, self.color_monster, (x+(s*3), y+(s*5), s,s))
        pygame.draw.rect(self.surface, self.color_monster, (x+(s*5), y+(s*5), s*2,s))
        pygame.draw.rect(self.surface, self.color_monster, (x+(s*8), y+(s*5), s,s))

        pygame.draw.rect(self.surface, self.color_monster, (x+(s*2), y+(s*6), s,s))
        pygame.draw.rect(self.surface, self.color_monster, (x+(s*9), y+(s*6 ), s,s))
